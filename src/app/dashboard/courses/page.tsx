...
function EnrollmentCard({ enrollment }: { enrollment: any }) {
  ...
  return (
    <Link href={`/dashboard/courses/${course.slug}`} className="glow-card overflow-hidden group block">
      ...
      <div className="p-4">
        ...
        <div className="h-1.5 bg-border rounded-full overflow-hidden">
          <div
            className={`h-full rounded-full transition-all ${enrollment.status === 'completed' ? 'bg-green-400' : 'bg-gradient-to-r from-primary to-secondary'}`}
